...
public class Confirm extends javax.swing.JFrame {
     ...
     */
    public Confirm(String reserveID) {
        initComponents();
        confirmField.setText(reserveID);
        this.res = res;
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Please save this number for your reference.");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Confirm(res).setVisible(true);
            }
        });
    }
